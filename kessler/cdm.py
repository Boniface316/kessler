...
class ConjunctionDataMessage:
    def __init__(self, file_name=None, set_defaults=True):
        ...
        self._keys_metadata_obligatory = [
            "OBJECT",
            "OBJECT_DESIGNATOR",
            "CATALOG_NAME",
            "OBJECT_NAME",
        ...
        self._keys_data_covariance_obligatory = [
            "CR_R",
            "CT_R",
            "CT_T",
            "CN_R",
        ...
        self._values_object_metadata = [
            dict.fromkeys(self._keys_metadata),
            dict.fromkeys(self._keys_metadata),
        ]
        self._values_object_data_od = [
            dict.fromkeys(self._keys_data_od),
            dict.fromkeys(self._keys_data_od),
        ]
        self._values_object_data_state = [
            dict.fromkeys(self._keys_data_state),
            dict.fromkeys(self._keys_data_state),
        ]
        self._values_object_data_covariance = [
            dict.fromkeys(self._keys_data_covariance),
            dict.fromkeys(self._keys_data_covariance),
        ]
    ...
    def copy_from(self, other_cdm):
        ...
        self._values_object_data_covariance = copy.deepcopy(
            other_cdm._values_object_data_covariance
        )
    ...
    def validate(self):
        ...
        val(
            self._keys_relative_metadata_obligatory,
            self._values_relative_metadata,
            "relative metadata",
        )
        ...
        val(
            self._keys_data_state_obligatory,
            self._values_object_data_state[0],
            "Object1 data (state)",
        )
        val(
            self._keys_data_covariance_obligatory,
            self._values_object_data_covariance[0],
            "Object1 data (covariance)",
        )
        ...
        val(
            self._keys_data_state_obligatory,
            self._values_object_data_state[1],
            "Object2 data (state)",
        )
        val(
            self._keys_data_covariance_obligatory,
            self._values_object_data_covariance[1],
            "Object2 data (covariance)",
        )
    ...
    def kvn(self, show_all=False):
        ...
        ret = append(
            ret, self._values_object_data_covariance[0], self._keys_data_covariance_obligatory
        )
        ...
        ret = append(
            ret, self._values_object_data_covariance[1], self._keys_data_covariance_obligatory
        )
        return ret
